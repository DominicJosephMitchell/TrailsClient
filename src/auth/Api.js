...
export const trailsCreate = ({ trail, town, state }, user) => {
  console.log(trail, town, state, user)
...
export const trailsDelete = (user, trailsId) => {
  return fetch(apiUrl + '/trails', {
    method: 'DELETE',
    headers: {
      'Content-Type': 'application/json',
...
export const trailsIndex = (user, id) => {
  return fetch(apiUrl + '/trails', {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json',
