...
class CardComponentAllTrails extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            trailed: this.props.trailed,
    ...
    render() {
        console.log('this.state.trail', this.state.trail)
        ...
        return (
            ...
            Level: {this.props.difficulty}
                ...
                <CardActions className="card-actions" disableActionSpacing>
                    ...
                    <Link to={this.state.trailed ? `/trails/${this.state.trailId}/show-completed-trail` : `/trails/${this.state.trailId}/show`} className="see-more" id={this.state.id} flash={this.props.flash}>See Stats</Link>
                </CardActions>
...
CardComponentAllTrails.propTypes = {
    classes: PropTypes.object.isRequired,
}

export default withStyles(styles)(CardComponentAllTrails)